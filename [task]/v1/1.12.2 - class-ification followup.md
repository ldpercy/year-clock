...
2025-11-12 		2.0.2	Second (shortened) followup done (2.🏛②)
2025-11-24		Re-versioned as v1.12.2
```
...
Some of the planned followup changes are going to get subsumed by the chaneover to temporal.
Also want to expedite the move to http-only so I can start working with modules.

So the changes for 2.0.2 are somewhat shortened:

* Convert sectors to use angular ranges
