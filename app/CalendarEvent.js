...
export function getYearEvent(date) {
...
export function getWeekEvent(date) {
...
export function getMonthEvent(date) {
...
export function getCustomEvent(date) {
...
export function getSeasonEvent(seasonId) {
